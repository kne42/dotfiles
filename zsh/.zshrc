...
__conda_setup="$('/Users/kevans/conda/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/kevans/conda/etc/profile.d/conda.sh" ]; then
        . "/Users/kevans/conda/etc/profile.d/conda.sh"
    else
        export PATH="/Users/kevans/conda/bin:$PATH"
    fi
fi
unset __conda_setup

if [ -f "/Users/kevans/conda/etc/profile.d/mamba.sh" ]; then
    . "/Users/kevans/conda/etc/profile.d/mamba.sh"
fi
# <<< conda initialize <<<
